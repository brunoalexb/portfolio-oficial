...
function About() {
  return (
    <section
      id="about"
      className="py-16 pt-20 bg-gradient-to-r from-gray-800 to-gray-600 min-h-screen flex items-start"
    >
      <div className="container mx-auto text-center">
        <h3 className="text-4xl text-white font-bold mb-4">Sobre Mim</h3>
        <p className="text-3xl text-white mb-6">
          Olá, sou um desenvolvedor web fullstack com paixão por transformar ideias em soluções, gerar impacto e agregar valor. 
        ...
        <p className="text-3xl text-white">
          Tenho experiência em Java, Spring Boot, React, Node.js, Tailwind CSS, e outras tecnologias modernas que me ajudam a criar interfaces 
